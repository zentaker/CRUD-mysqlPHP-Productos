...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2021 a las 01:46:50
...
INSERT INTO `category` (`id_categoria`, `categoryName`, `categoryDescription`, `creationDate`, `updationDate`) VALUES
...
(84, 3, NULL, 'mal', 'undefined', 3232, NULL, NULL, 'g', NULL, NULL, NULL, NULL, '2021-06-17 21:22:40', NULL);
...
INSERT INTO `subcategory` (`id_subcategoria`, `categoryid`, `subcategory`, `creationDate`, `updationDate`) VALUES
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`id_categoria`) REFERENCES `category` (`id_categoria`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`id_subcategoria`) REFERENCES `subcategory` (`id_subcategoria`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
